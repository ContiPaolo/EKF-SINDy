...
sindy_library = [lambda x: x, 
                ...
                lambda x1, x2, x3, x4, al, be: x1*x4,
                lambda x1, x2, x3, x4, al, be: x1*al,
                lambda x1, x2, x3, x4, al, be: x1*be,

                lambda x1, x2, x3, x4, al, be: x2*x2,
                lambda x1, x2, x3, x4, al, be: x2*x3,
                lambda x1, x2, x3, x4, al, be: x2*x4,
                lambda x1, x2, x3, x4, al, be: x2*al,
                lambda x1, x2, x3, x4, al, be: x2*be,

                lambda x1, x2, x3, x4, al, be: x3*x3,
                lambda x1, x2, x3, x4, al, be: x3*x4,
                lambda x1, x2, x3, x4, al, be: x3*al,
                lambda x1, x2, x3, x4, al, be: x3*be,

                lambda x1, x2, x3, x4, al, be: x4*x4,
                lambda x1, x2, x3, x4, al, be: x4*al,
                lambda x1, x2, x3, x4, al, be: x4*be,

                lambda x1, x2, x3, x4, al, be: al*al,
